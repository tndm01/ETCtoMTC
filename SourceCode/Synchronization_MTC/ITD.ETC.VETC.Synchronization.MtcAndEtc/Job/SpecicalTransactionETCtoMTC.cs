        ...
        private void ProcessSpecialTransaction()
        {
            try
            {
                ...
                if (config != null)
                {
                    ...
                    if (specialJob != null)
                    {
                        SpecialTransactionProcess oSpecialTransaction = new SpecialTransactionProcess(specialTransactionTable, specialJob.FullSourcePath,
                            specialJob.FullDesticationPath);
                        oSpecialTransaction.SpecialProcessData();
                    }
                }
            }
            catch (Exception ex)
