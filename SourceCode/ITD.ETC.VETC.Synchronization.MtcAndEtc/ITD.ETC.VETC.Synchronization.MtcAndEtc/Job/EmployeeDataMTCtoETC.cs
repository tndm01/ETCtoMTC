    ...
    public class EmployeeDataMTCtoETC : IJob
    {
        ...
        private void ProcessEmployeeData()
        {
            try
            {
                ...
                string EmployeeTable = Resources.EmployeeTableName;
                ...
                if (config != null)
                {
                    ...
                    if (employeeJob != null)
                    {
                        EmployeeProcess employees = new EmployeeProcess(EmployeeTable, employeeJob.FullSourcePath,
